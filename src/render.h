...
extern PHP_FUNCTION(Render_XML);
extern PHP_FUNCTION(Render_HTML);
extern PHP_FUNCTION(Render_Man);
extern PHP_FUNCTION(Render_CommonMark);
extern PHP_FUNCTION(Render_Latex);
