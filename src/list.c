...
static zend_function_entry php_cmark_node_list_methods[] = {
	PHP_ABSTRACT_ME(List, setTight, php_cmark_node_list_set_tight)
	PHP_ABSTRACT_ME(List, isTight, php_cmark_no_arginfo)
	PHP_ABSTRACT_ME(List, setDelimitPeriod, php_cmark_no_arginfo)
	PHP_ABSTRACT_ME(List, setDelimitParen, php_cmark_no_arginfo)
	PHP_ABSTRACT_ME(List, hasPeriodDelim, php_cmark_no_arginfo)
	PHP_ABSTRACT_ME(List, hasParenDelim, php_cmark_no_arginfo)
	PHP_FE_END
};
...
PHP_MINIT_FUNCTION(CommonMark_Node_List) {
	...
	INIT_NS_CLASS_ENTRY(ce, "CommonMark\\Interfaces", "IList", php_cmark_node_list_methods);

	php_cmark_node_list_ce = zend_register_internal_interface(&ce);
	...
	zend_class_implements(php_cmark_node_list_ordered_ce, 1, php_cmark_node_list_ce);
	...
	zend_class_implements(php_cmark_node_list_bullet_ce, 1, php_cmark_node_list_ce);
...
{
	php_cmark_node_list_ce->ce_flags |= ZEND_ACC_FINAL;
